...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lur_robot_driver_plugin;/opt/ros/noetic/lib/x86_64-linux-gnu/liburcl.so".split(';') if "-lur_robot_driver_plugin;/opt/ros/noetic/lib/x86_64-linux-gnu/liburcl.so" != "" else []
PROJECT_NAME = "ur_robot_driver"
PROJECT_SPACE_DIR = "/home/huangyi/devspace/pybullet-test/install"
